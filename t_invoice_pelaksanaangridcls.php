...
$t_invoice_pelaksanaan_grid = NULL; // Initialize page object first

class ct_invoice_pelaksanaan_grid extends ct_invoice_pelaksanaan {
	...
	// Page object name
	var $PageObjName = 't_invoice_pelaksanaan_grid';

	// Grid form hidden field names
	var $FormName = 'ft_invoice_pelaksanaangrid';
...
//			if (!isset($GLOBALS["Table"])) $GLOBALS["Table"] = &$GLOBALS["t_invoice_pelaksanaan"];
