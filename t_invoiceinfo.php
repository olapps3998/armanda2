...
class ct_invoice extends cTable {
	...
	function __construct() {
		...
		// total
		$this->total = new cField('t_invoice', 't_invoice', 'x_total', 'total', '`total`', '`total`', 3, -1, FALSE, '`total`', FALSE, FALSE, FALSE, 'FORMATTED TEXT', 'TEXT');
		...
		// total_ppn
		$this->total_ppn = new cField('t_invoice', 't_invoice', 'x_total_ppn', 'total_ppn', '`total_ppn`', '`total_ppn`', 3, -1, FALSE, '`total_ppn`', FALSE, FALSE, FALSE, 'FORMATTED TEXT', 'TEXT');
