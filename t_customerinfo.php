...
//
// Table class for t_customer
//
class ct_customer extends cTable {
	...
	function __construct() {
		...
		$this->TableVar = 't_customer';
		$this->TableName = 't_customer';
		$this->TableType = 'TABLE';

		// Update Table
		$this->UpdateTable = "`t_customer`";
		$this->DBID = 'DB';
		$this->ExportAll = TRUE;
		...
		// customer_id
		$this->customer_id = new cField('t_customer', 't_customer', 'x_customer_id', 'customer_id', '`customer_id`', '`customer_id`', 3, -1, FALSE, '`customer_id`', FALSE, FALSE, FALSE, 'FORMATTED TEXT', 'NO');
		...
		// nama
		$this->nama = new cField('t_customer', 't_customer', 'x_nama', 'nama', '`nama`', '`nama`', 200, -1, FALSE, '`nama`', FALSE, FALSE, FALSE, 'FORMATTED TEXT', 'TEXT');
		$this->nama->Sortable = TRUE; // Allow sort
		$this->fields['nama'] = &$this->nama;

		// alamat
		$this->alamat = new cField('t_customer', 't_customer', 'x_alamat', 'alamat', '`alamat`', '`alamat`', 201, -1, FALSE, '`alamat`', FALSE, FALSE, FALSE, 'FORMATTED TEXT', 'TEXTAREA');
		$this->alamat->Sortable = TRUE; // Allow sort
		$this->fields['alamat'] = &$this->alamat;

		// kota
		$this->kota = new cField('t_customer', 't_customer', 'x_kota', 'kota', '`kota`', '`kota`', 200, -1, FALSE, '`kota`', FALSE, FALSE, FALSE, 'FORMATTED TEXT', 'TEXT');
		$this->kota->Sortable = TRUE; // Allow sort
		$this->fields['kota'] = &$this->kota;

		// kodepos
		$this->kodepos = new cField('t_customer', 't_customer', 'x_kodepos', 'kodepos', '`kodepos`', '`kodepos`', 200, -1, FALSE, '`kodepos`', FALSE, FALSE, FALSE, 'FORMATTED TEXT', 'TEXT');
		$this->kodepos->Sortable = TRUE; // Allow sort
		$this->fields['kodepos'] = &$this->kodepos;

		// npwp
		$this->npwp = new cField('t_customer', 't_customer', 'x_npwp', 'npwp', '`npwp`', '`npwp`', 200, -1, FALSE, '`npwp`', FALSE, FALSE, FALSE, 'FORMATTED TEXT', 'TEXT');
	...
	function getSqlFrom() { // From
		return ($this->_SqlFrom <> "") ? $this->_SqlFrom : "`t_customer`";
	}
	...
	function GetViewUrl($parm = "") {
		if ($parm <> "")
			$url = $this->KeyUrl("t_customerview.php", $this->UrlParm($parm));
		else
			$url = $this->KeyUrl("t_customerview.php", $this->UrlParm(EW_TABLE_SHOW_DETAIL . "="));
	...
	function GetAddUrl($parm = "") {
		if ($parm <> "")
			$url = "t_customeradd.php?" . $this->UrlParm($parm);
		else
			$url = "t_customeradd.php";
		return $this->AddMasterUrl($url);
	}

	// Edit URL
	function GetEditUrl($parm = "") {
		$url = $this->KeyUrl("t_customeredit.php", $this->UrlParm($parm));
		return $this->AddMasterUrl($url);
	}
	...
	function GetCopyUrl($parm = "") {
		$url = $this->KeyUrl("t_customeradd.php", $this->UrlParm($parm));
		return $this->AddMasterUrl($url);
	}
	...
	function GetDeleteUrl() {
		return $this->KeyUrl("t_customerdelete.php", $this->UrlParm());
	}
