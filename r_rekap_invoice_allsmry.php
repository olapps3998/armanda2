...
//		$item->Visible = TRUE;
	...
	function GetRow($opt) {
		...
		if (!$rs->EOF) {
			...
			$this->Val[7] = $this->tgl_bayar->CurrentValue;
		} else {
			$this->periode_short->setDbValue("");
	...
	function RenderRow() {
		...
		if ($this->RowType == EWR_ROWTYPE_TOTAL && !($this->RowTotalType == EWR_ROWTOTAL_GROUP && $this->RowTotalSubType == EWR_ROWTOTAL_HEADER)) { // Summary row
			...
			$this->tanggal->CellAttrs["style"] = "width: 100px;";
	...
	function GetSessionDropDownValue(&$fld) {
		$parm = substr($fld->FldVar, 2);
		$this->GetSessionValue($fld->DropDownValue, 'sv_r_rekap_invoice_all_' . $parm);
		$this->GetSessionValue($fld->SearchOperator, 'so_r_rekap_invoice_all_' . $parm);
	}

	// Get filter values from session
	function GetSessionFilterValues(&$fld) {
		$parm = substr($fld->FldVar, 2);
		$this->GetSessionValue($fld->SearchValue, 'sv_r_rekap_invoice_all_' . $parm);
		$this->GetSessionValue($fld->SearchOperator, 'so_r_rekap_invoice_all_' . $parm);
		$this->GetSessionValue($fld->SearchCondition, 'sc_r_rekap_invoice_all_' . $parm);
		$this->GetSessionValue($fld->SearchValue2, 'sv2_r_rekap_invoice_all_' . $parm);
		$this->GetSessionValue($fld->SearchOperator2, 'so2_r_rekap_invoice_all_' . $parm);
	}
	...
	function SetSessionDropDownValue($sv, $so, $parm) {
		$_SESSION['sv_r_rekap_invoice_all_' . $parm] = $sv;
		$_SESSION['so_r_rekap_invoice_all_' . $parm] = $so;
	}

	// Set filter values to session
	function SetSessionFilterValues($sv1, $so1, $sc, $sv2, $so2, $parm) {
		$_SESSION['sv_r_rekap_invoice_all_' . $parm] = $sv1;
		$_SESSION['so_r_rekap_invoice_all_' . $parm] = $so1;
		$_SESSION['sc_r_rekap_invoice_all_' . $parm] = $sc;
		$_SESSION['sv2_r_rekap_invoice_all_' . $parm] = $sv2;
		$_SESSION['so2_r_rekap_invoice_all_' . $parm] = $so2;
	}
	...
	function ClearSessionSelection($parm) {
		$_SESSION["sel_r_rekap_invoice_all_$parm"] = "";
		$_SESSION["rf_r_rekap_invoice_all_$parm"] = "";
		$_SESSION["rt_r_rekap_invoice_all_$parm"] = "";
	}
...
// Form object
var CurrentForm = fr_rekap_invoice_allsummary = new ewr_Form("fr_rekap_invoice_allsummary");

// Validate method
fr_rekap_invoice_allsummary.Validate = function() {
...
fr_rekap_invoice_allsummary.Form_CustomValidate = 
...
fr_rekap_invoice_allsummary.ValidateRequired = true; // Uses JavaScript validation
<?php } else { ?>
fr_rekap_invoice_allsummary.ValidateRequired = false; // No JavaScript validation
<?php } ?>
...
<?php if ($Page->Export == "" && !$Page->DrillDown) { ?>
<!-- Search form (begin) -->
<form name="fr_rekap_invoice_allsummary" id="fr_rekap_invoice_allsummary" class="form-inline ewForm ewExtFilterForm" action="<?php echo ewr_CurrentPage() ?>">
...
<script type="text/javascript">
fr_rekap_invoice_allsummary.Init();
fr_rekap_invoice_allsummary.FilterList = <?php echo $Page->GetFilterList() ?>;
</script>
<!-- Search form (end) -->
<?php } ?>
...
<?php if ($Page->periode_short->Visible) { ?>
	...
	<?php } else { ?>
<?php if ($Page->Export <> "" || $Page->DrillDown) { ?>
	<td data-field="periode_short"><div class="r_rekap_invoice_all_periode_short" style="width: 100px;"><span class="ewTableHeaderCaption"><?php echo $Page->periode_short->FldCaption() ?></span></div></td>
<?php } else { ?>
	<td data-field="periode_short">
<?php if ($Page->SortUrl($Page->periode_short) == "") { ?>
		<div class="ewTableHeaderBtn r_rekap_invoice_all_periode_short" style="width: 100px;">
			<span class="ewTableHeaderCaption"><?php echo $Page->periode_short->FldCaption() ?></span>
		</div>
<?php } else { ?>
		<div class="ewTableHeaderBtn ewPointer r_rekap_invoice_all_periode_short" onclick="ewr_Sort(event,'<?php echo $Page->SortUrl($Page->periode_short) ?>',2);" style="width: 100px;">
			<span class="ewTableHeaderCaption"><?php echo $Page->periode_short->FldCaption() ?></span>
...
<?php if ($Page->tanggal->Visible) { ?>
	...
	<?php } else { ?>
<?php if ($Page->Export <> "" || $Page->DrillDown) { ?>
	<td data-field="tanggal"><div class="r_rekap_invoice_all_tanggal" style="width: 100px;"><span class="ewTableHeaderCaption"><?php echo $Page->tanggal->FldCaption() ?></span></div></td>
<?php } else { ?>
	<td data-field="tanggal">
<?php if ($Page->SortUrl($Page->tanggal) == "") { ?>
		<div class="ewTableHeaderBtn r_rekap_invoice_all_tanggal" style="width: 100px;">
			<span class="ewTableHeaderCaption"><?php echo $Page->tanggal->FldCaption() ?></span>
		</div>
<?php } else { ?>
		<div class="ewTableHeaderBtn ewPointer r_rekap_invoice_all_tanggal" onclick="ewr_Sort(event,'<?php echo $Page->SortUrl($Page->tanggal) ?>',2);" style="width: 100px;">
			<span class="ewTableHeaderCaption"><?php echo $Page->tanggal->FldCaption() ?></span>
...
<?php if ($Page->tanggal_short->Visible) { ?>
	...
	<?php } else { ?>
<?php if ($Page->Export <> "" || $Page->DrillDown) { ?>
	<td data-field="tanggal_short"><div class="r_rekap_invoice_all_tanggal_short" style="width: 100px;"><span class="ewTableHeaderCaption"><?php echo $Page->tanggal_short->FldCaption() ?></span></div></td>
<?php } else { ?>
	<td data-field="tanggal_short">
<?php if ($Page->SortUrl($Page->tanggal_short) == "") { ?>
		<div class="ewTableHeaderBtn r_rekap_invoice_all_tanggal_short" style="width: 100px;">
			<span class="ewTableHeaderCaption"><?php echo $Page->tanggal_short->FldCaption() ?></span>
		</div>
<?php } else { ?>
		<div class="ewTableHeaderBtn ewPointer r_rekap_invoice_all_tanggal_short" onclick="ewr_Sort(event,'<?php echo $Page->SortUrl($Page->tanggal_short) ?>',2);" style="width: 100px;">
			<span class="ewTableHeaderCaption"><?php echo $Page->tanggal_short->FldCaption() ?></span>
...
<?php if ($Page->Export <> "" || $Page->DrillDown) { ?>
	<td data-field="nama"><div class="r_rekap_invoice_all_nama" style="width: 200px;"><span class="ewTableHeaderCaption"><?php echo $Page->nama->FldCaption() ?></span></div></td>
<?php } else { ?>
	<td data-field="nama">
<?php if ($Page->SortUrl($Page->nama) == "") { ?>
		<div class="ewTableHeaderBtn r_rekap_invoice_all_nama" style="width: 200px;">
			<span class="ewTableHeaderCaption"><?php echo $Page->nama->FldCaption() ?></span>
		</div>
<?php } else { ?>
		<div class="ewTableHeaderBtn ewPointer r_rekap_invoice_all_nama" onclick="ewr_Sort(event,'<?php echo $Page->SortUrl($Page->nama) ?>',2);" style="width: 200px;">
			<span class="ewTableHeaderCaption"><?php echo $Page->nama->FldCaption() ?></span>
...
<?php if ($Page->Export <> "" || $Page->DrillDown) { ?>
	<td data-field="no_kwitansi"><div class="r_rekap_invoice_all_no_kwitansi" style="width: 100px;"><span class="ewTableHeaderCaption"><?php echo $Page->no_kwitansi->FldCaption() ?></span></div></td>
<?php } else { ?>
	<td data-field="no_kwitansi">
<?php if ($Page->SortUrl($Page->no_kwitansi) == "") { ?>
		<div class="ewTableHeaderBtn r_rekap_invoice_all_no_kwitansi" style="width: 100px;">
			<span class="ewTableHeaderCaption"><?php echo $Page->no_kwitansi->FldCaption() ?></span>
		</div>
<?php } else { ?>
		<div class="ewTableHeaderBtn ewPointer r_rekap_invoice_all_no_kwitansi" onclick="ewr_Sort(event,'<?php echo $Page->SortUrl($Page->no_kwitansi) ?>',2);" style="width: 100px;">
			<span class="ewTableHeaderCaption"><?php echo $Page->no_kwitansi->FldCaption() ?></span>
...
<?php if ($Page->Export <> "" || $Page->DrillDown) { ?>
	<td data-field="nomor"><div class="r_rekap_invoice_all_nomor" style="width: 200px;"><span class="ewTableHeaderCaption"><?php echo $Page->nomor->FldCaption() ?></span></div></td>
<?php } else { ?>
	<td data-field="nomor">
<?php if ($Page->SortUrl($Page->nomor) == "") { ?>
		<div class="ewTableHeaderBtn r_rekap_invoice_all_nomor" style="width: 200px;">
			<span class="ewTableHeaderCaption"><?php echo $Page->nomor->FldCaption() ?></span>
		</div>
<?php } else { ?>
		<div class="ewTableHeaderBtn ewPointer r_rekap_invoice_all_nomor" onclick="ewr_Sort(event,'<?php echo $Page->SortUrl($Page->nomor) ?>',2);" style="width: 200px;">
			<span class="ewTableHeaderCaption"><?php echo $Page->nomor->FldCaption() ?></span>
...
<?php if ($Page->Export <> "" || $Page->DrillDown) { ?>
	<td data-field="tgl_pelaksanaan"><div class="r_rekap_invoice_all_tgl_pelaksanaan"><span class="ewTableHeaderCaption"><?php echo $Page->tgl_pelaksanaan->FldCaption() ?></span></div></td>
<?php } else { ?>
	<td data-field="tgl_pelaksanaan">
<?php if ($Page->SortUrl($Page->tgl_pelaksanaan) == "") { ?>
		<div class="ewTableHeaderBtn r_rekap_invoice_all_tgl_pelaksanaan">
...
<?php if ($Page->Export <> "" || $Page->DrillDown) { ?>
	<td data-field="total_ppn"><div class="r_rekap_invoice_all_total_ppn" style="text-align: right;"><span class="ewTableHeaderCaption"><?php echo $Page->total_ppn->FldCaption() ?></span></div></td>
<?php } else { ?>
	<td data-field="total_ppn">
<?php if ($Page->SortUrl($Page->total_ppn) == "") { ?>
		<div class="ewTableHeaderBtn r_rekap_invoice_all_total_ppn" style="text-align: right;">
...
<?php if ($Page->Export <> "" || $Page->DrillDown) { ?>
		<span class="ewSummaryCaption r_rekap_invoice_all_periode_short"><span class="ewTableHeaderCaption"><?php echo $Page->periode_short->FldCaption() ?></span></span>
<?php } else { ?>
	<?php if ($Page->SortUrl($Page->periode_short) == "") { ?>
		<span class="ewSummaryCaption r_rekap_invoice_all_periode_short">
			<span class="ewTableHeaderCaption"><?php echo $Page->periode_short->FldCaption() ?></span>
		</span>
	<?php } else { ?>
		<span class="ewTableHeaderBtn ewPointer ewSummaryCaption r_rekap_invoice_all_periode_short" onclick="ewr_Sort(event,'<?php echo $Page->SortUrl($Page->periode_short) ?>',2);">
			<span class="ewTableHeaderCaption"><?php echo $Page->periode_short->FldCaption() ?></span>
			<span class="ewTableHeaderSort"><?php if ($Page->periode_short->getSort() == "ASC") { ?><span class="caret ewSortUp"></span><?php } elseif ($Page->periode_short->getSort() == "DESC") { ?><span class="caret"></span><?php } ?></span>
		</span>
	<?php } ?>
...
<span data-class="tpx<?php echo $Page->GrpCount ?>_r_rekap_invoice_all_periode_short"<?php echo $Page->periode_short->ViewAttributes() ?>><?php echo $Page->periode_short->GroupViewValue ?></span>
...
<?php } else { ?>
	...
	<?php } else { ?>
		<span class="ewTableHeaderBtn ewPointer ewSummaryCaption r_rekap_invoice_all_tanggal" onclick="ewr_Sort(event,'<?php echo $Page->SortUrl($Page->tanggal) ?>',2);">
			<span class="ewTableHeaderCaption"><?php echo $Page->tanggal->FldCaption() ?></span>
			<span class="ewTableHeaderSort"><?php if ($Page->tanggal->getSort() == "ASC") { ?><span class="caret ewSortUp"></span><?php } elseif ($Page->tanggal->getSort() == "DESC") { ?><span class="caret"></span><?php } ?></span>
		</span>
	<?php } ?>
<?php } ?>
		<?php echo $ReportLanguage->Phrase("SummaryColon") ?>
<span data-class="tpx<?php echo $Page->GrpCount ?>_<?php echo $Page->GrpCounter[0] ?>_r_rekap_invoice_all_tanggal"<?php echo $Page->tanggal->ViewAttributes() ?>><?php echo $Page->tanggal->GroupViewValue ?></span>
...
<?php if ($Page->Export <> "" || $Page->DrillDown) { ?>
		<span class="ewSummaryCaption r_rekap_invoice_all_tanggal_short"><span class="ewTableHeaderCaption"><?php echo $Page->tanggal_short->FldCaption() ?></span></span>
<?php } else { ?>
	<?php if ($Page->SortUrl($Page->tanggal_short) == "") { ?>
		<span class="ewSummaryCaption r_rekap_invoice_all_tanggal_short">
			<span class="ewTableHeaderCaption"><?php echo $Page->tanggal_short->FldCaption() ?></span>
		</span>
	<?php } else { ?>
		<span class="ewTableHeaderBtn ewPointer ewSummaryCaption r_rekap_invoice_all_tanggal_short" onclick="ewr_Sort(event,'<?php echo $Page->SortUrl($Page->tanggal_short) ?>',2);">
			<span class="ewTableHeaderCaption"><?php echo $Page->tanggal_short->FldCaption() ?></span>
			<span class="ewTableHeaderSort"><?php if ($Page->tanggal_short->getSort() == "ASC") { ?><span class="caret ewSortUp"></span><?php } elseif ($Page->tanggal_short->getSort() == "DESC") { ?><span class="caret"></span><?php } ?></span>
		</span>
	<?php } ?>
<?php } ?>
		<?php echo $ReportLanguage->Phrase("SummaryColon") ?>
<span data-class="tpx<?php echo $Page->GrpCount ?>_<?php echo $Page->GrpCounter[0] ?>_<?php echo $Page->GrpCounter[1] ?>_r_rekap_invoice_all_tanggal_short"<?php echo $Page->tanggal_short->ViewAttributes() ?>><?php echo $Page->tanggal_short->GroupViewValue ?></span>
...
<span data-class="tpx<?php echo $Page->GrpCount ?>_r_rekap_invoice_all_periode_short"<?php echo $Page->periode_short->ViewAttributes() ?>><?php echo $Page->periode_short->GroupViewValue ?></span></td>
	<?php } ?>
<?php } ?>
<?php if ($Page->tanggal->Visible) { ?>
	<?php if ($Page->tanggal->ShowGroupHeaderAsRow) { ?>
...
<span data-class="tpx<?php echo $Page->GrpCount ?>_<?php echo $Page->GrpCounter[0] ?>_r_rekap_invoice_all_tanggal"<?php echo $Page->tanggal->ViewAttributes() ?>><?php echo $Page->tanggal->GroupViewValue ?></span></td>
	<?php } ?>
<?php } ?>
<?php if ($Page->tanggal_short->Visible) { ?>
	<?php if ($Page->tanggal_short->ShowGroupHeaderAsRow) { ?>
...
<span data-class="tpx<?php echo $Page->GrpCount ?>_<?php echo $Page->GrpCounter[0] ?>_<?php echo $Page->GrpCounter[1] ?>_r_rekap_invoice_all_tanggal_short"<?php echo $Page->tanggal_short->ViewAttributes() ?>><?php echo $Page->tanggal_short->GroupViewValue ?></span></td>
	<?php } ?>
<?php } ?>
<?php if ($Page->nama->Visible) { ?>
		<td data-field="nama"<?php echo $Page->nama->CellAttributes() ?>>
<span data-class="tpx<?php echo $Page->GrpCount ?>_<?php echo $Page->GrpCounter[0] ?>_<?php echo $Page->GrpCounter[1] ?>_<?php echo $Page->RecCount ?>_r_rekap_invoice_all_nama"<?php echo $Page->nama->ViewAttributes() ?>><?php echo $Page->nama->ListViewValue() ?></span></td>
<?php } ?>
<?php if ($Page->no_kwitansi->Visible) { ?>
		<td data-field="no_kwitansi"<?php echo $Page->no_kwitansi->CellAttributes() ?>>
<span data-class="tpx<?php echo $Page->GrpCount ?>_<?php echo $Page->GrpCounter[0] ?>_<?php echo $Page->GrpCounter[1] ?>_<?php echo $Page->RecCount ?>_r_rekap_invoice_all_no_kwitansi"<?php echo $Page->no_kwitansi->ViewAttributes() ?>><?php echo $Page->no_kwitansi->ListViewValue() ?></span></td>
<?php } ?>
<?php if ($Page->nomor->Visible) { ?>
		<td data-field="nomor"<?php echo $Page->nomor->CellAttributes() ?>>
<span data-class="tpx<?php echo $Page->GrpCount ?>_<?php echo $Page->GrpCounter[0] ?>_<?php echo $Page->GrpCounter[1] ?>_<?php echo $Page->RecCount ?>_r_rekap_invoice_all_nomor"<?php echo $Page->nomor->ViewAttributes() ?>><?php echo $Page->nomor->ListViewValue() ?></span></td>
<?php } ?>
<?php if ($Page->no_sertifikat->Visible) { ?>
		<td data-field="no_sertifikat"<?php echo $Page->no_sertifikat->CellAttributes() ?>>
<span data-class="tpx<?php echo $Page->GrpCount ?>_<?php echo $Page->GrpCounter[0] ?>_<?php echo $Page->GrpCounter[1] ?>_<?php echo $Page->RecCount ?>_r_rekap_invoice_all_no_sertifikat"<?php echo $Page->no_sertifikat->ViewAttributes() ?>><?php echo $Page->no_sertifikat->ListViewValue() ?></span></td>
<?php } ?>
<?php if ($Page->tgl_pelaksanaan->Visible) { ?>
		<td data-field="tgl_pelaksanaan"<?php echo $Page->tgl_pelaksanaan->CellAttributes() ?>>
<span data-class="tpx<?php echo $Page->GrpCount ?>_<?php echo $Page->GrpCounter[0] ?>_<?php echo $Page->GrpCounter[1] ?>_<?php echo $Page->RecCount ?>_r_rekap_invoice_all_tgl_pelaksanaan"<?php echo $Page->tgl_pelaksanaan->ViewAttributes() ?>><?php echo $Page->tgl_pelaksanaan->ListViewValue() ?></span></td>
<?php } ?>
<?php if ($Page->total_ppn->Visible) { ?>
		<td data-field="total_ppn"<?php echo $Page->total_ppn->CellAttributes() ?>>
<span data-class="tpx<?php echo $Page->GrpCount ?>_<?php echo $Page->GrpCounter[0] ?>_<?php echo $Page->GrpCounter[1] ?>_<?php echo $Page->RecCount ?>_r_rekap_invoice_all_total_ppn"<?php echo $Page->total_ppn->ViewAttributes() ?>><?php echo $Page->total_ppn->ListViewValue() ?></span></td>
<?php } ?>
<?php if ($Page->tgl_bayar->Visible) { ?>
		<td data-field="tgl_bayar"<?php echo $Page->tgl_bayar->CellAttributes() ?>>
<span data-class="tpx<?php echo $Page->GrpCount ?>_<?php echo $Page->GrpCounter[0] ?>_<?php echo $Page->GrpCounter[1] ?>_<?php echo $Page->RecCount ?>_r_rekap_invoice_all_tgl_bayar"<?php echo $Page->tgl_bayar->ViewAttributes() ?>><?php echo $Page->tgl_bayar->ListViewValue() ?></span></td>
<?php } ?>
	</tr>
<?php
...
<?php } ?>
<?php if ($Page->no_sertifikat->Visible) { ?>
		<td data-field="no_sertifikat"<?php echo $Page->tanggal_short->CellAttributes() ?>></td>
<?php } ?>
<?php if ($Page->tgl_pelaksanaan->Visible) { ?>
		<td data-field="tgl_pelaksanaan"<?php echo $Page->tanggal_short->CellAttributes() ?>></td>
<?php } ?>
<?php if ($Page->total_ppn->Visible) { ?>
		<td data-field="total_ppn"<?php echo $Page->tanggal_short->CellAttributes() ?>><span class="ewAggregateCaption"><?php echo $ReportLanguage->Phrase("RptSum") ?></span><?php echo $ReportLanguage->Phrase("AggregateEqual") ?><span class="ewAggregateValue"><span data-class="tpgs<?php echo $Page->GrpCount ?>_<?php echo $Page->GrpCounter[0] ?>_<?php echo $Page->GrpCounter[1] ?>_r_rekap_invoice_all_total_ppn"<?php echo $Page->total_ppn->ViewAttributes() ?>><?php echo $Page->total_ppn->SumViewValue ?></span></span></td>
<?php } ?>
<?php if ($Page->tgl_bayar->Visible) { ?>
		<td data-field="tgl_bayar"<?php echo $Page->tanggal_short->CellAttributes() ?>></td>
<?php } ?>
	</tr>
<?php } else { ?>
	<tr<?php echo $Page->RowAttributes(); ?>>
...
<?php if ($Page->SubGrpColumnCount + $Page->DtlColumnCount - 1 > 0) { ?>
		<td colspan="<?php echo ($Page->SubGrpColumnCount + $Page->DtlColumnCount - 1) ?>"<?php echo $Page->tgl_bayar->CellAttributes() ?>><?php echo str_replace(array("%v", "%c"), array($Page->tanggal_short->GroupViewValue, $Page->tanggal_short->FldCaption()), $ReportLanguage->Phrase("RptSumHead")) ?> <span class="ewDirLtr">(<?php echo ewr_FormatNumber($Page->Cnt[3][0],0,-2,-2,-2) ?><?php echo $ReportLanguage->Phrase("RptDtlRec") ?>)</span></td>
<?php } ?>
	</tr>
	<tr<?php echo $Page->RowAttributes(); ?>>
<?php if ($Page->periode_short->Visible) { ?>
...
<span data-class="tpgs<?php echo $Page->GrpCount ?>_<?php echo $Page->GrpCounter[0] ?>_<?php echo $Page->GrpCounter[1] ?>_r_rekap_invoice_all_total_ppn"<?php echo $Page->total_ppn->ViewAttributes() ?>><?php echo $Page->total_ppn->SumViewValue ?></span></td>
<?php } ?>
<?php if ($Page->tgl_bayar->Visible) { ?>
		<td data-field="tgl_bayar"<?php echo $Page->tanggal_short->CellAttributes() ?>>&nbsp;</td>
<?php } ?>
...
<?php if ($Page->SubGrpColumnCount + $Page->DtlColumnCount > 0) { ?>
		<td colspan="<?php echo ($Page->SubGrpColumnCount + $Page->DtlColumnCount) ?>"<?php echo $Page->tgl_bayar->CellAttributes() ?>><?php echo str_replace(array("%v", "%c"), array($Page->tanggal->GroupViewValue, $Page->tanggal->FldCaption()), $ReportLanguage->Phrase("RptSumHead")) ?> <span class="ewDirLtr">(<?php echo ewr_FormatNumber($Page->Cnt[2][0],0,-2,-2,-2) ?><?php echo $ReportLanguage->Phrase("RptDtlRec") ?>)</span></td>
<?php } ?>
	</tr>
	<tr<?php echo $Page->RowAttributes(); ?>>
<?php if ($Page->periode_short->Visible) { ?>
...
<?php if ($Page->total_ppn->Visible) { ?>
		<td data-field="total_ppn"<?php echo $Page->tgl_bayar->CellAttributes() ?>>
<span data-class="tpgs<?php echo $Page->GrpCount ?>_<?php echo $Page->GrpCounter[0] ?>_r_rekap_invoice_all_total_ppn"<?php echo $Page->total_ppn->ViewAttributes() ?>><?php echo $Page->total_ppn->SumViewValue ?></span></td>
<?php } ?>
<?php if ($Page->tgl_bayar->Visible) { ?>
		<td data-field="tgl_bayar"<?php echo $Page->tanggal->CellAttributes() ?>>&nbsp;</td>
<?php } ?>
...
<?php } ?>
<?php if ($Page->no_sertifikat->Visible) { ?>
		<td data-field="no_sertifikat"<?php echo $Page->periode_short->CellAttributes() ?>></td>
<?php } ?>
<?php if ($Page->tgl_pelaksanaan->Visible) { ?>
		<td data-field="tgl_pelaksanaan"<?php echo $Page->periode_short->CellAttributes() ?>></td>
<?php } ?>
<?php if ($Page->total_ppn->Visible) { ?>
...
<?php } ?>
<?php if ($Page->tgl_bayar->Visible) { ?>
		<td data-field="tgl_bayar"<?php echo $Page->periode_short->CellAttributes() ?>></td>
<?php } ?>
	</tr>
<?php } else { ?>
	<tr<?php echo $Page->RowAttributes(); ?>>
<?php if ($Page->GrpColumnCount + $Page->DtlColumnCount > 0) { ?>
		<td colspan="<?php echo ($Page->GrpColumnCount + $Page->DtlColumnCount) ?>"<?php echo $Page->tgl_bayar->CellAttributes() ?>><?php echo str_replace(array("%v", "%c"), array($Page->periode_short->GroupViewValue, $Page->periode_short->FldCaption()), $ReportLanguage->Phrase("RptSumHead")) ?> <span class="ewDirLtr">(<?php echo ewr_FormatNumber($Page->Cnt[1][0],0,-2,-2,-2) ?><?php echo $ReportLanguage->Phrase("RptDtlRec") ?>)</span></td>
<?php } ?>
	</tr>
	<tr<?php echo $Page->RowAttributes(); ?>>
<?php if ($Page->GrpColumnCount > 0) { ?>
...
//$(".ewRptGrpSummary<n>").has("span.ewDirLtr").parent().hide(); // Replace <n> with the actual summary group (1,2,3,4)

$(".ewSummaryCount").hide(); // Replace <n> with the actual summary group (1,2,3,4)
