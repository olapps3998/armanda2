...
class ct_invoice_fee extends cTable {
	...
	function __construct() {
		...
		// harga
		$this->harga = new cField('t_invoice_fee', 't_invoice_fee', 'x_harga', 'harga', '`harga`', '`harga`', 3, -1, FALSE, '`harga`', FALSE, FALSE, FALSE, 'FORMATTED TEXT', 'TEXT');
		...
		// jumlah
		$this->jumlah = new cField('t_invoice_fee', 't_invoice_fee', 'x_jumlah', 'jumlah', '`jumlah`', '`jumlah`', 3, -1, FALSE, '`jumlah`', FALSE, FALSE, FALSE, 'FORMATTED TEXT', 'TEXT');
	...
	function Insert(&$rs) {
		...
		if ($bInsert) {
			...
			$this->invoice_detail_id->setDbValue($conn->Insert_ID());
			$rs['invoice_detail_id'] = $this->invoice_detail_id->DbValue;
