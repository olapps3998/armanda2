...
$c_kwitansi01_php = NULL; // Initialize page object first

class cc_kwitansi01_php {
	...
	// Table name
	var $TableName = 'c_kwitansi01.php';

	// Page object name
	var $PageObjName = 'c_kwitansi01_php';
	...
	function __construct() {
		...
		if (!defined("EW_TABLE_NAME"))
			define("EW_TABLE_NAME", 'c_kwitansi01.php', TRUE);
	...
	function SetupBreadcrumb() {
		...
		$Breadcrumb->Add("custom", "c_kwitansi01_php", $url, "", "c_kwitansi01_php", TRUE);
	}
}
?>
<?php ew_Header(FALSE) ?>
...
// Create page object
if (!isset($c_kwitansi01_php)) $c_kwitansi01_php = new cc_kwitansi01_php();

// Page init
$c_kwitansi01_php->Page_Init();

// Page main
$c_kwitansi01_php->Page_Main();
...
<html>
	...
	<body>
		<form method="post" action="c_kwitansi02.php">
			Pilih No. Kwitansi :
			<select name="no_kwitansi">
				...
				while($row = mysql_fetch_array($mquery)) {
					?>
				<option value="<?php echo $row["no_kwitansi"]?>"><?php echo $row["no_kwitansi"]?></option>
					<?php
				}
				?>
			</select>
...
<?php
$c_kwitansi01_php->Page_Terminate();
?>
