...
class cdefault {
	...
	function Page_Main() {
		...
		if ($Security->AllowList(CurrentProjectID() . 't_customer'))
			$this->Page_Terminate("t_customerlist.php");
		if ($Security->AllowList(CurrentProjectID() . 't_fee'))
			$this->Page_Terminate("t_feelist.php");
		if ($Security->AllowList(CurrentProjectID() . 't_invoice'))
			$this->Page_Terminate("t_invoicelist.php");
