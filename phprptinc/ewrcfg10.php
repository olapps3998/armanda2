...
define("EWR_PROJECT_ID", "{A9671DEB-57B5-48F0-BE68-784D09E2FE7C}", TRUE); // Project ID
define("EWR_PROJECT_NAME", "armanda2", TRUE); // Project Name
...
$EWR_CONN["DB"] = array("conn" => NULL, "id" => "DB", "type" => "MYSQL", "host" => "localhost", "port" => 3306, "user" => "root", "pass" => "admin", "db" => "db_armanda2", "qs" => "`", "qe" => "`");
...
define("EWR_RANDOM_KEY", '0J7RGn5GZI412xkq', TRUE); // Random key for encryption
...
// User admin
define("EWR_LOGIN_SELECT_SQL", "SELECT * FROM `t_user`", TRUE);

// User table filters
define("EWR_USER_TABLE_DBID", "DB", TRUE);
define("EWR_USER_TABLE", "`t_user`", TRUE);
...
define("EWR_TABLE_PREFIX", "{A9671DEB-57B5-48F0-BE68-784D09E2FE7C}", TRUE);
